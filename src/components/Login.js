    ...
    <div>
      <div class="font-[sans-serif]">
        ...
        <div class="mx-4 mb-4 -mt-16">
          <form class="w-[600px] mx-auto bg-white shadow-[0_2px_13px_-6px_rgba(0,0,0,0.4)] sm:p-8 p-4 rounded-md">
            <div class="md:grid-cols-2 flex flex-col gap-8">
              <button type="button"
            ...
            <div class="flex flex-col md:grid-cols-2 gap-8">
            ...
            <div class="mt-8 flex justify-center">
              <button type="button" class="py-3 px-6 text-sm tracking-wider font-semibold w-[500px] rounded-md text-white bg-blue-500 hover:bg-blue-600 focus:outline-none">
                Login
              </button>
            </div>
          </form>
