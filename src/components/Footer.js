      ...
      <footer className="bg-gradient-to-b from-gray-900/[.19] to-blue-900 dark:bg-gray-900">
        <div className="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div className="md:hidden">
                ...
                <div className="space-y-4">
                    ...
                    <div className="border-b border-gray-700 pb-4">
                        <h3 className="mb-3 text-sm font-semibold text-gray-900 uppercase dark:text-white flex items-center justify-between">
                            Company
                            <span className="text-gray-400">+</span>
                        </h3>
                        <ul className="text-gray-500 dark:text-gray-400 flex flex-wrap">
                    ...
                    <div className="border-b border-gray-700 pb-4">
                        ...
                        <ul className="text-gray-500 dark:text-gray-400 flex flex-wrap">
                            ...
                            <li className="w-1/2 mb-3">
                                <a href="/" className="hover:underline">Vivaswanth Hero</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div className="hidden md:grid md:grid-cols-3 lg:grid-cols-5 gap-8">
                ...
                <div>
                    <h3 className="mb-4 text-sm font-semibold text-gray-900 uppercase dark:text-white">Help center</h3>
                    <ul className="text-gray-500 dark:text-gray-400">
                        <li className="mb-3">
                            <a href="/" className="hover:underline">Discord Server</a>
                        </li>
                ...
                <div>
                    <h3 className="mb-4 text-sm font-semibold text-gray-900 uppercase dark:text-white">Download</h3>
                    <ul className="text-gray-500 dark:text-gray-400">
                        <li className="mb-3">
                            <a href="/" className="hover:underline">iOS</a>
                        </li>
            ...
            <div className="text-center">
                <a href="/" className="flex items-center justify-center mb-5 text-xl font-semibold text-gray-900 dark:text-white">
                    <img src={logo} className="h-6 mr-2 sm:h-8" alt="Civic-Alliance Logo" />
                    Civic-Alliance    
                </a>

                <span className="block text-sm text-center text-gray-500 dark:text-gray-400">© 2024 . All Rights Reserved</span>
                <ul className="flex flex-wrap justify-center mt-5 space-x-4">
                    <li>
